        ...
        <div className="prose prose-lg prose-p:text-navy prose-headings:text-navy prose-li:text-slate">
          ...
          <div className="space-y-6 text-navy leading-relaxed">
            ...
            <p className="p-5 border border-stone-900/15 rounded-sm hover:border-stone-900/40 hover:bg-stone-900/5 transition-all duration-300">
              <b>On a related note:</b> Building this archive has been a deep dive into using AI to organize and structure chaotic, fragmented information. I am currently applying this same underlying technology to a very modern problem: travel planning. If you are the type of person who researches trips with fifty open tabs and scattered notes, I am building <Link target="_blank" href="https://placez.io/research" className="text-accent-green hover:text-navy transition-colors underline decoration-accent-green/30 underline-offset-4">Placez — essentially a NotebookLM for travel</Link>. It uses the same principles of AI-powered structuring to turn messy travel research into a mapped, reality-checked itinerary.
            </p>
