...
export default function SocialGraphPage() {
  ...
  return (
    <div className="container mx-auto py-10 px-4">
      <h1 className="text-3xl font-bold mb-6 text-stone-800">Archive Search</h1>
      <p className="text-stone-600 mb-8">
        Enter a name (e.g., "Churchill", "WSC", "Violet") to find all mentions in the correspondence and diaries.
      </p>

      <div className="mb-10 space-y-4">
        <div className="flex flex-wrap gap-3 max-w-3xl items-start">
          <div className="flex-1 relative min-w-[240px]" ref={wrapperRef}>
              <Input 
              type="text" 
          ...
          <Button
            ...
            aria-controls="social-graph-filters"
          >
        ...
        {showFilters && (
          <div
            id="social-graph-filters"
            className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4 bg-stone-50 border border-stone-200 rounded-lg p-4"
          >
            <div className="space-y-1">
              <label htmlFor="date-from" className="text-xs font-medium text-stone-600">
                From
              </label>
            <Input
              id="date-from"
          ...
          <div className="space-y-1">
            <label htmlFor="date-to" className="text-xs font-medium text-stone-600">
              To
            </label>
            <Input
              id="date-to"
            ...
            <div className="space-y-1">
              <label htmlFor="author-filter" className="text-xs font-medium text-stone-600">
                Author
              </label>
              <Input
                id="author-filter"
            ...
            <div className="space-y-1">
              <label htmlFor="recipient-filter" className="text-xs font-medium text-stone-600">
                Recipient
              </label>
              <Input
                id="recipient-filter"
