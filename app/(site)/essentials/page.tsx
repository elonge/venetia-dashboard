            ...
            <div className="max-w-4xl mx-auto px-6">
                <div className="flex items-start gap-4 mb-8">
                    ...
                    <div>
                        ...
                        <div className="mt-3">
                            <Link href="/chapter/asquith-letters-venetia-stanley" className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-accent-brown hover:text-navy transition-colors group/link">
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-10">
                    ...
                    <div className="flex justify-center pt-4">
                        <Link href="/chapter/asquith-venetia-after-1915" className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-accent-brown hover:text-navy transition-colors group/link">
                            <span>Read Full Chapter</span>
                            <ArrowRight size={14} className="group-hover/link:translate-x-1 transition-transform" />
                        </Link>
                    </div>
