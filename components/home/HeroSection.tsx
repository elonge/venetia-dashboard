...
export default function HeroSection() {
  return (
    <div className="bg-[#F5F0E8] rounded-2xl overflow-hidden mb-6 border border-black/10 shadow-[0_18px_44px_rgba(0,0,0,0.16)]">
      <div className="relative w-full">
        <img 
          src="/asquith_venetia_split_screen.jpg"
          alt="Historical portrait"
          className="w-full h-[260px] md:h-[320px] object-cover sepia"
        />
        ...
        <div className="absolute bottom-0 left-0 p-4 text-white pointer-events-none">
          ...
          <h2 className="font-serif text-2xl leading-tight max-w-3xl">
