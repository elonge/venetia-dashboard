export const TIMELINE_DATA = [
  ...
  },
  {
    ...
    coords: [45.923, 6.869], // Chamonix Lat/Lng
    diaryEntry:
      "I am utterly mewed up in this beastly far-away inn. Oliver is here, of course, but the charm of Chamonix is lost on me today. My mind wanders back to Sicily—the warmth, the light—so different from this frozen isolation. I have sent H. a long account of our existence here, though I fear he will find it dreadfully dull. I must remember to forward those addresses he asked for; even here, the 'Enchantress' and travel plans seem the only things worth discussing.",
    historicalFacts: [
  ...
  },
  {
    ...
    diaryEntry:
      "Down at Tilstone Lodge for the hunting. The mud is frightful but the run was glorious. H. mocks my 'calls and cares,' but he is quite right—this life is its own little tyranny. Mother sent a hilarious cutting claiming H.'s visits to Alderley are motivated by the 'Non-conformist grievance in single-school areas'! I sent it on to him; he needs the laugh. Also wrote to Edwin—it is his birthday, and I must pin him down for dinner Sunday.",
    historicalFacts: [
  ...
  },
  {
    ...
    diaryEntry:
      "A relentlessly wet, dreary Sunday at The Wharf. We had intended to golf, but the sky opened up and drowned the links. Instead, we bundled into the closed motor and drove through the grey countryside. There is something strangely comforting about being sealed inside the car with him, watching the rain streak the glass, safe from the mud and the politics. Nature has forced us to do exactly what we needed: nothing.",
    historicalFacts: [
  ...
  },
{
  ...
  visualPrompt: "Interior of an Edwardian bedroom, 1914, open steamer trunks with silk dresses spilling out, a crumpled letter resting on a vanity table in the foreground, soft natural light, atmospheric and slightly chaotic.",
...
},
{
  ...
  diaryEntry: "I stayed down here rather than rushing up to London yesterday. The sea air gave me a burst of courage—I have cut a fringe! It is quite an 'adventurous coiffure,' though I wonder if H. will approve or just stare at me in that puzzled way of his. I wrote him two letters today to make up for my absence. It is strange how one can feel closer to someone when miles apart than when sitting across a crowded dinner table.",
  historicalFacts: [
  ...
  visualPrompt: "View of a calm English seaside at Littlestone, 1914, looking out from a window with white lace curtains blowing in the breeze, a silver hand-mirror and scissors on the windowsill, soft coastal light.",
...
},
{
  ...
  visualPrompt: "Close up of an elegant Edwardian writing desk, 1914, a fountain pen resting on cream stationery, hand-written text visible but blurry, warm lamplight illuminating the desk while the background is in shadow.",
...
},
{
  ...
  coords: [53.300, -4.610], // Near Holyhead Golf Club
  diaryEntry: "A round of golf on the Holyhead links this afternoon. It was a 'threesome'—myself, H., and Hockey, the local professional. H. played well, though the wind off the Irish Sea is unforgiving. It is strange to see reporters watching from the edge of the course, scribbling down our partners and our scores for the papers. They call it 'The Premier's Holiday,' but to me, it is just a walk on the grass with a friend, trying to ignore the coming drizzle.",
  historicalFacts: [
  ...
  visualPrompt: "Vintage 1914 style view of a golf course on the coast of Wales (Holyhead), overcast sky, three figures in period golf attire (long skirts, tweed jackets) walking on the green, sea visible in the distance, grainy texture.",
...
},
{
  ...
  coords: [51.413, -0.676],
  diaryEntry: "Ascot for the Hunt Cup today. The weather was perfect—one of those rare English summer days where the light flatters everyone. I walked the paddock with Diana [Manners]; we saw Winston there, looking restless as usual, and the Duchess of Newcastle in a peacock blue charmeuse that demanded attention. It was less crowded than Tuesday, which meant one could actually walk without being trampled by taffeta. But after hours of bobbing to the Royal Box and discussing odds, I was desperate to escape. I motored back to London to see H. tonight; the only race that truly interests me is the one he is running in Westminster.",
  historicalFacts: [
  ...
  visualPrompt: "Edwardian crowd scene at Ascot Racecourse 1914, sunny day, women in large hats and white dresses with parasols walking on the green grass, men in top hats, impressionistic style capturing the dappled sunlight.",
...
},
{
  ...
  diaryEntry: "Covent Garden for the Strauss tonight. The music is so thick and complex, it batters against your senses. My head is still spinning from it—or perhaps from the lack of sleep. It was a relief to see H. yesterday without the shadow of politics hanging over us for once. Just two people talking. Tonight, amidst the crashing chords and the diamond tiaras, that quiet hour seems infinitely more precious.",
  historicalFacts: [
  ...
  visualPrompt: "View from a box at the Royal Opera House 1914, looking down at the illuminated stage and the dark velvety audience, red velvet curtains in foreground, opera glasses resting on the ledge.",
...
},
{
  ...
  visualPrompt: "Interior of Albert Hall Dundee 1914, royal reception, crowded with dignitaries, focus on two elegant women in foreground (one in yellow striped silk, one in black with pink roses), flags and bunting, soft indoor lighting.",
...
},
{
  ...
  location: 'Penrhos, Anglesey',
  coords: [53.300, -4.610],
  diaryEntry: "I am sitting on the rocks, staring at the grey sea. It feels a million miles from the madness in London, yet H.'s letters bring the panic right to my feet. This war... it seems like such a disproportionate remedy. As I told H., it is like cutting off one’s head to get rid of a headache. He writes so faithfully, even now. I try to send him the peace of this place, but I fear the headache is going to kill us all.",
  historicalFacts: [
  ...
  visualPrompt: "A solitary woman in a white Edwardian dress sitting on rugged grey seaside rocks, looking out at a turbulent Irish Sea, overcast sky, moody and contemplative, oil painting style.",
...
},
{
  ...
  visualPrompt: "Interior view of an Edwardian country house bedroom, a woman in a striped dress standing by a window looking out at a rain-swept garden, reflection in the glass, sense of waiting and anxiety.",
...
},
{
  ...
  location: 'Penrhos, Anglesey',
  coords: [53.295, -4.608],
  diaryEntry: "The clock ticks towards midnight and the expiration of the ultimatum. I feel a terrible restlessness. We moved the tent today, dragging canvas across the grass as if preparing for our own little campaign. I read H.'s letters to the family—carefully editing, of course. They listen for news of the war; I look for news of the man. I had planned to go to Lulworth, but everything is suspended now. We are all just waiting.",
  historicalFacts: [
  ...
  visualPrompt: "A white canvas tent pitched on a grassy lawn at twilight in 1914, shadows lengthening, a large country house visible in the distance with lights glowing in the windows, ominous moody sky.",
...
},
{
  ...
  location: 'Mansfield 18, London',
  coords: [51.519689936407765, -0.14560590552324795],
  diaryEntry: "Sent H. a sprig of myrtle today. I wonder if he knows it is the emblem of love? It seemed the only soft thing in a hard world. To distract myself from the news, I have buried my head in Pope's 'Dunciad'—satire feels safer than reality right now. The Assyrian is here, grousing away about his own importance. I listen, but my thoughts are entirely with the Prime Minister's speech.",
  historicalFacts: [
  ...
  visualPrompt: "Still life 1914 style: an open leather-bound book (Pope's Dunciad) on a table, a fresh sprig of green myrtle resting on the page, and a handwritten envelope addressed to the Prime Minister nearby.",
...
},
{
  ...
  visualPrompt: "View from inside a moving 1914 motor car, looking out the open window at a blurred English country lane (Roehampton), a crumpled piece of white paper flying out of the window into the green hedgerow, sense of motion.",
...
},
{
  ...
  visualPrompt: "Interior of an ancient English manor library (Mells), 1914, leather-bound books, a copy of Keats lying open on a heavy oak table, soft candlelight, atmosphere of quiet melancholy.",
  ...
  visualPrompt: "Exterior of the Viceregal Lodge in Dublin, 1914, imposing white neoclassical architecture, immaculate lawns with guests in formal Edwardian garden party attire, Union Jack flying, sense of occasion.",
...
},
{
  ...
  visualPrompt: "Atmospheric interior of a library at night, 1914, empty armchair near a fireplace with dying embers, an open volume of Shakespeare on a side table, sense of absence and quiet melancholy.",
...
},
{
  ...
  diaryEntry: "I am writing this from my little room at the London Hospital. The smell of carbolic and the cries from the wards are a strange accompaniment to my thoughts of Downing Street. Here, I am just a probationer learning to bandage; yet on my table sits the 'gaudy casket'—that flashy little box holding H.'s most secret papers. It is a bizarre dual existence: scrubbing floors by day, guarding the Empire's secrets by night. I only wish he were here in this narrow room with me.",  
  historicalFacts: [
  ...
  visualPrompt: "Exterior view of The Royal London Hospital in Whitechapel, 1914, imposing Edwardian red brick architecture, busy street scene with early ambulances and nurses in uniform walking near the gates, atmospheric and slightly gritty.",
...
},
{
  ...
  visualPrompt: "Close up of an oil lamp burning brightly on a desk in a dark room 1914, illuminating a handwritten letter, warm golden glow against deep shadows, intimate and symbolic.",
...
},
{
  ...
  visualPrompt: "Atmospheric view of Lympne Castle 1914 at dusk, looking out over the Romney Marsh towards the sea, mist rising, muted colours of grey and green, a vintage car parked in the foreground.",
...
},
{
  ...
  visualPrompt: "Reflection of a young woman in an Edwardian vanity mirror 1914, looking serious and contemplative, soft lighting, silver hairbrush and perfume bottles on the table, mood of introspection.",
...
},
{
  ...
  visualPrompt: "Interior of a warm, lamp-lit drawing room in London 1914, heavy velvet curtains drawn against the night, two armchairs facing each other, a discarded newspaper on the floor, atmosphere of intimacy and safety.",
...
},
{
  ...
  coords: [51.500, -0.134],
  diaryEntry: "Flowers arrived from the Assyrian today—huge, extravagant blooms, typical of him. I sent a polite note back with a tiny Christmas present for Rosie. I must go and see him before the holiday, I suppose. Meanwhile, H. writes anxiously about the Russian artillery and the new armies. It is a strange life: thanking one man for hothouse flowers while advising another on the movement of guns across Europe.",
  historicalFacts: [
  ...
  visualPrompt: "Still life 1914: A large, extravagant bouquet of flowers in a vase, a small wrapped Christmas gift, and a handwritten note on '24 Queen Anne's Gate' stationery, set against a window with a wintry London street outside.",
...
},
{
  ...
  location: 'Deal, Kent',
  coords: [51.221, 1.402],
  diaryEntry: "Motored over to Deal today. We managed a round of golf, but my mind was elsewhere. Later, we visited the bungalow where the wounded soldiers are staying. Seeing them there—bandaged, quiet, shattered—makes all our talk in London seem so theoretical. I feel I have truly taken up a new profession now. It is not just a game or a uniform anymore; it is real work, and God knows there is enough of it to do.",
  historicalFacts: [
  ...
  visualPrompt: "A windswept English seaside scene at Deal 1914, a woman in a heavy coat walking towards a wooden bungalow, wounded soldiers in convalescent blue uniforms sitting on the porch, grey sea in the background.",
